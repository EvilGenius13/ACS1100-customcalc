...
def daily_interest_calc(interest_rate_input, amount_input, days_owing_input):
    ...
    print(f" Here is the calculation {interest_rate_input} / 100 / 365 * ${amount_input} * {days_owing_input} = ")
    return total_owing
    
    
final_calc = daily_interest_calc
print(final_calc(interest_rate, amount_owing, days_owing))
print(f"That is the total amount of interest you will pay on ${amount_owing} after {days_owing} days at {interest_rate} percent")